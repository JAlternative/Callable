...
org_file_name = 'content/OrganizationUnit_1.txt'
emp_pos_file_name = 'content/employeeposition (2).txt'
demand_test_org_1 = [
    'name',
    'active',
    'parentOuterId',
...
def test_org_test_3_required_fields(con_db, object):
    ...
    try:
        ...
        with open('content/test_org_test_3_required_fields.txt', 'a+') as f:
