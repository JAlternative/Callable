    ...
    stages {
        stage('Run tests') {
            parallel {
                stage('Schedule') {
                    stages{
                        stage('SCHED7-12, SCHED16-17, SCHED20-24, SCHED32, SCHED33, SCHED35-36, SCHED39, SCHED41 OTHER13') {
                            options {
                                timeout(time: 8, unit: 'HOURS')
                            }
                            steps {
                                pl_step('magnit1', 'magnitqa-wfm.goodt.tech',
                                        'magnit_SCHED7_8_10_11 magnit_SCHED9 magnit_SCHED12_16_17_32 magnit_SCHED20_21_22_24 magnit_SCHED33_35_36_39 magnit_SCHED41')
                            }
                            post {
                                always {
                ...
                stage('Non-schedule') {
                    stages {
                        stage('MIX, N2, PS, AUTH1') {
                            options {
                                timeout(time: 3, unit: 'HOURS')
                            }
                            steps {
                                testing_step('magnit2', 'magnitqa-wfm.goodt.tech', 'magnit_MIX magnit_OTHER_PS_AUTH_N2')
                            }
                            post {
                                always {
                        ...
                        stage('BC, LIST, REP') {
                            ...
                            steps {
                                testing_step('magnit3', 'magnitqa-wfm.goodt.tech', 'magnit_BC magnit_LIST_Sched magnit_LIST_Mix magnit_REP')
                            }
                            post {
                                always {
                                    stash_results("magnit3")
                                }
                            }
                        }
                    }
